...
const NAV: NavItem[] = [
  ...
  { href: "/dashboard/investigations", label: "Investigations",  icon: <SearchIcon /> },
  { href: "/dashboard/reviews",        label: "Review Queue",    icon: <ClipboardIcon /> },
  { href: "/dashboard/audit",          label: "Audit Trail",     icon: <DocumentIcon /> },
  { href: "/dashboard/test-payment",   label: "Test Payments",   icon: <CreditCardIcon /> },
];
  ...
  return (
    <aside className="flex flex-col w-56 min-h-screen bg-slate-900 border-r border-slate-800 shrink-0">
      ...
      <div className="flex items-center gap-2.5 px-5 py-5 border-b border-slate-800">
        ...
        <div>
          <span className="text-sm font-bold text-white tracking-tight">Riskora</span>
          <span className="text-xs text-slate-500 block leading-none">AI Risk Ops</span>
        </div>
      </div>
      ...
      <nav className="flex-1 px-3 py-4" aria-label="Main navigation">
        ...
        <div className="border-t border-slate-800 pt-4">
          <p className="text-[10px] uppercase tracking-widest text-slate-600 px-3 mb-2">System</p>
          {SYSTEM.map((item) => (
            <Link
              key={item.href}
              href={item.href}
